                    ...
                    <form class="mt-6" action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col gap-3 w-full justify-between mb-6">
                            <div class="mb-3">
                                ...
                                <x-text-input type="text" name="name" class="mt-3 w-full"></x-text-input>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input type="email" name="email" class="mt-3 w-full"></x-text-input>
                                @error('email')
                                    <div class="text-rose-500">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="">
                                ...
                                <x-text-input type="password" name="password" class="mt-3 w-full"></x-text-input>
                                @error('password')
                                    <div class="text-rose-500">{{ $message }}</div>
                                @enderror
                            </div>
